...
- (void)viewDidLoad {
    ...
    self.title = [@"main_search_title" localize];
            ...
            [[APIManager sharedInstance] ticketsWithRequest:_searchRequest withCompletion:^(NSArray *tickets) {
                [[ProgressView sharedInstance] dismiss: ^{
                    if (tickets.count > 0) {
                        ...
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:[@"oops" localize] message:[@"tickets_not_found" localize] preferredStyle: UIAlertControllerStyleAlert];
